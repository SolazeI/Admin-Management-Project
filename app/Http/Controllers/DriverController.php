...
class DriverController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'phone_number'        => 'required|digits_between:7,11|unique:drivers,phone_number',
                ...
                'phone_number.digits_between'     => 'Phone number must be between 7 and 11 digits.',
                ...
                'emergency_contact.digits_between'=> 'Emergency contact must be between 7 and 11 digits.',
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $validated = $request->validate([
                'full_name'           => 'required|string|min:2|max:255',
                'phone_number'        => 'required|digits_between:7,11|unique:drivers,phone_number,' . $id,
